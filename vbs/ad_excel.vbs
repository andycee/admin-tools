...
objCommand.CommandText = _
    "SELECT givenName, SN, department, telephoneNumber FROM " & "'LDAP://ou=Users,ou=Accounting,ou=Kaiserhof,dc=Kaiserhof,dc=heliopark,dc=ru' WHERE " & "objectCategory='user'"  
